    ...
    return (
        <div className="mt-16 flex items-center flex-col">
            ...
            <div className="px-10 sm:w-[50%] sm.:px-0 mt-6 text-xl text-justify">
                Created in 2022 by a group of students from the Degree in
                Computer Science at the University of Minho for the course unit
                project. ComputacionalMind was devised by teachers Pedro Rangel
                Henriques and Cristiana Araújo with the aim of bringing
                computational thinking to everyone, but especially to younger
                people, in order to prepare new generations for an increasingly
                computerised world.
            </div>
            <div className="mt-6 flex justify-center items-center gap-x-10">
