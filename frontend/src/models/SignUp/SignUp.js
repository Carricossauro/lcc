      ...
      <div className="bg-white min-h-[450px] h-[90%] w-[90%] lg:h-[700px] lg:w-[1200px] rounded-lg drop-shadow-xl flex flex-col">
        ...
        <div className="w-full flex flex-row h-full">
          ...
          <form className="w-full lg:w-1/2 flex justify-center flex-col items-center">
            ...
            <div
              className={`flex items-center px-3 h-12 w-72 sm:w-96 bg-stone-200 border rounded-3xl mb-3 ${
                errorLocation === "username" ? "border-red-800" : ""
              }`}
            >
              <FontAwesomeIcon
                icon={faUser}
            ...
            <div
              className={`flex items-center px-3 h-12 w-72 sm:w-96 bg-stone-200 border rounded-3xl mb-3 ${
                errorLocation === "email" ? "border-red-800" : ""
              }`}
            >
              <FontAwesomeIcon
                icon={faEnvelope}
            ...
            <div
              className={`flex items-center px-3 h-12 w-72 sm:w-96 bg-stone-200 border rounded-3xl mb-3 ${
                errorLocation === "password" ? "border-red-800" : ""
              }`}
            >
              <FontAwesomeIcon
                icon={faLock}
            ...
            <div
              className={`flex items-center px-3 h-12 w-72 sm:w-96 bg-stone-200 border rounded-3xl ${
            ...
            {!isAuthor && (
              <div
                className={`flex items-center px-3 h-12 w-72 sm:w-96 bg-stone-200 border rounded-3xl ${
                  ...
                  errorLocation === "birthday" ? "border-red-800" : ""
                } text-neutral-500`}
              >
                <FontAwesomeIcon
                  icon={faCalendar}
                  className="text-2xl  text-neutral-500 ml-2.5"
                />
                <label className="ml-3 w-11/12">birthday</label>
                <input
            ...
            <button
              className="flex items-center justify-center h-12 w-72 sm:w-96 rounded-3xl cursor-pointer bg-color1 text-lg hover:text-white duration-500"
