                ...
                <div className="w-3/5 h-inherit flex flex-wrap justify-end items-center">
                    ...
                    {props.loggedIn && (
                        <>
                            ...
                            <div className="flex justify-center mx-3 mr-6">
                                <button className="flex items-center justify-center w-24 h-9 bg-color1 rounded cursor-pointer hover:text-color4 hover:font-bold duration-1000">
                                    {initials(props.name)}
                                </button>
                            </div>
                        </>
                ...
                >
                    ...
                    <div className="flex justify-center my-3">
                        <button
                            ...
                            onClick={() => redirect("/Login")} // TODO - logged in navbar mobile
                        >
                            LOGIN
                        </button>
                    </div>
