...
class Author(models.Model):
    id = models.CharField(db_column='Id', primary_key=True, max_length=75)  # Field name made lowercase.
...
class History(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    player = models.ForeignKey('Player', models.DO_NOTHING, db_column='Player')  # Field name made lowercase.
...
class Question(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    author = models.ForeignKey(Author, models.DO_NOTHING, db_column='Author')  # Field name made lowercase.
