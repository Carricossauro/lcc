...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{p2d}\mathbin{::}[\mskip1.5mu \Q \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{p2d}\mathrel{=}[\mskip1.5mu \mathrm{1.2},\mathrm{3.4}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{p3d}\mathbin{::}[\mskip1.5mu \Q \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{p3d}\mathrel{=}[\mskip1.5mu \mathrm{0.2},\mathrm{10.3},\mathrm{2.4}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcLine}\mathbin{::}\Conid{NPoint}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{g}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}i_2\;((\Varid{x},\Varid{x}),[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{g}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{g}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}[\mskip1.5mu \mskip1.5mu])\mathrel{=}i_2\;((\Varid{x},\Varid{y}),[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{g}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}\Varid{t})\mathrel{=}i_2\;((\Varid{x},\Varid{y}),\Varid{y}\mathbin{:}\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{p}\;\Varid{t}\mathrel{=}\alt{\Varid{nil}}{\Varid{pp2}\;\Varid{t}}{}\<[E]%
\\
\>[B]{}\Varid{pp2}\;\Varid{t}\;((\Varid{x},\Varid{y}),\Varid{r})\mathrel{=}\Varid{calcLine}\;\Varid{x}\;\Varid{y}\;\Varid{t}\mathbin{:}\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{teste}\;\Varid{t}\mathrel{=}\Varid{cataList}\;(\Varid{p}\;\Varid{t})\comp \Varid{anaList}\;\Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
