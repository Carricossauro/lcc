...
A solução para \ensuremath{\Varid{outExpAr}} pode ser obtida através da igualdade \ensuremath{\Varid{outExpAr}\comp \Varid{inExpAr}\mathrel{=}\Varid{id}}:
\begin{eqnarray*}
\start
  \ensuremath{\Varid{outExpAr}\comp \Varid{inExpAr}\mathrel{=}\Varid{id}}
%
\just\equiv{ Def-\ensuremath{\Varid{inExpAr}} }
%
  \ensuremath{\Varid{outExpAr}\comp [\mskip1.5mu \underline{\Conid{X}},\Varid{num\char95 ops}\mskip1.5mu]\mathrel{=}\Varid{id}}
%
\just\equiv{ Universal-+; Def-\ensuremath{\Varid{num\char95 ops}}; Fusão-+ }
%
\begin{lcbr}
  \ensuremath{\Varid{outExpAr}\comp \underline{\Conid{X}}\mathrel{=}i_1}
\\
  \ensuremath{\Varid{outExpAr}\comp [\mskip1.5mu \Conid{N},\Varid{ops}\mskip1.5mu]\mathrel{=}i_2}
\end{lcbr}
%
\just\equiv{ Universal-+; Def-\ensuremath{\Varid{ops}}; Fusão-+ }
%
\begin{lcbr}
    \ensuremath{\Varid{outExpAr}\comp \underline{\Conid{X}}\mathrel{=}i_1}
\\
...
\\
    \ensuremath{\Varid{outExpAr}\comp [\mskip1.5mu \Varid{bin},\uncurry{\Conid{Un}}\mskip1.5mu]\mathrel{=}i_2\comp i_2}
\end{lcbr}
%
...
\\
    \ensuremath{\Varid{outExpAr}\;(\Conid{N}\;\Varid{x})\mathrel{=}i_2\;(i_1\;\Varid{x})}
\\
    \ensuremath{\Varid{outExpAr}\;(\Varid{bin}\;(\Varid{op},(\Varid{a},\Varid{b})))\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{a},\Varid{b}))))}
\\
    \ensuremath{\Varid{outExpAr}\;(\uncurry{\Conid{Un}}\;(\Varid{x},\Varid{y}))\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{x},\Varid{y})))}
\end{lcbr}
%
\just\equiv{ Def-\ensuremath{\Varid{bin}}; Def-\ensuremath{\uncurry{\cdot }} }
%
\end{eqnarray*}
...
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{x}\;\Varid{y})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{x},\Varid{y}))){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\Varid{num\char95 ops}\mathrel{=}\alt{\Varid{id}}{\Varid{ops}}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\Varid{ops}\mathrel{=}\alt{\Varid{bina}}{\uncurry{\Varid{unar}}}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\Varid{bina}\;(\Conid{Sum},\Varid{par})\mathrel{=}\uncurry{(\mathbin{+})}\;\Varid{par}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\Varid{bina}\;(\Conid{Product},\Varid{par})\mathrel{=}\uncurry{(\mathbin{*})}\;\Varid{par}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\Varid{unar}\;\Conid{Negate}\mathrel{=}\Varid{negate}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\Varid{unar}\;\Conid{E}\mathrel{=}\Varid{expd}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\mathrm{1})\;\Varid{b})\mathrel{=}\Varid{clean}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;(\Conid{N}\;\mathrm{1}))\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;(\Conid{N}\;\mathrm{0})\;\Varid{b})\mathrel{=}\Varid{clean}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;(\Conid{N}\;\mathrm{0}))\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{Negate}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{a}))\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\underline{(\Conid{X},\Conid{N}\;\mathrm{1})}}{\Varid{q}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{q}\mathrel{=}\alt{\Varid{constante}}{\Varid{ops}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{constante}\mathrel{=}\conj{\Conid{N}\comp \Varid{id}}{\Conid{N}\comp \underline{\mathrm{0}}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{ops}\mathrel{=}\alt{\Varid{binar}}{\Varid{unar}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{unar}\;(\Conid{E},(\Varid{x1},\Varid{dx1}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{x1},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{x1})\;\Varid{dx1}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{unar}\;(\Conid{Negate},(\Varid{x1},\Varid{dx1}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{x1},\Conid{Un}\;\Conid{Negate}\;\Varid{dx1}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{binar}\;(\Conid{Sum},((\Varid{x1},\Varid{dx1}),(\Varid{x2},\Varid{dx2})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{x1}\;\Varid{x2},\Conid{Bin}\;\Conid{Sum}\;\Varid{dx1}\;\Varid{dx2}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{binar}\;\Varid{x}\mathrel{=}(\Varid{esq}\;\Varid{x},\Varid{dir}\;\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{esq}\;(\Conid{Product},((\Varid{x1},\Varid{dx1}),(\Varid{x2},\Varid{dx2})))\mathrel{=}\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;\Varid{x2}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{dir}\;(\Conid{Product},((\Varid{x1},\Varid{dx1}),(\Varid{x2},\Varid{dx2})))\mathrel{=}\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;\Varid{dx2})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{dx1}\;\Varid{x2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{v}\mathrel{=}\alt{\Varid{b}}{\Varid{q}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{b}\;()\mathrel{=}(\Varid{v},\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{q}\mathrel{=}\alt{\Varid{constante}}{\Varid{ops}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{constante}\;\Varid{x}\mathrel{=}(\Varid{x},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{ops}\mathrel{=}\alt{\Varid{binar}}{\Varid{unar}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{binar}\;(\Conid{Sum},((\Varid{x1},\Varid{dx1}),(\Varid{x2},\Varid{dx2})))\mathrel{=}(\Varid{x1}\mathbin{+}\Varid{x2},\Varid{dx1}\mathbin{+}\Varid{dx2}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{binar}\;(\Conid{Product},((\Varid{x1},\Varid{dx1}),(\Varid{x2},\Varid{dx2})))\mathrel{=}(\Varid{x1}\mathbin{*}\Varid{x2},(\Varid{x1}\mathbin{*}\Varid{dx2})\mathbin{+}(\Varid{dx1}\mathbin{*}\Varid{x2})){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{unar}\;(\Conid{Negate},(\Varid{x1},\Varid{dx1}))\mathrel{=}(\mathbin{-}\Varid{x1},\mathbin{-}\Varid{dx1}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{unar}\;(\Conid{E},(\Varid{x1},\Varid{dx1}))\mathrel{=}(\Varid{expd}\;\Varid{x1},\Varid{dx1}\mathbin{*}\Varid{expd}\;\Varid{x1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\mathrel{=}\Varid{b}\times\Varid{d}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{succ2}\mathrel{=}(\mathrm{2}\mathbin{+}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{d}\mathrel{=}\conj{\Varid{succ2}\comp \p1}{\Varid{mul}\comp (\Varid{mul}\comp \conj{\Varid{succ2}}{\succ }\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}((\mathrm{0},\mathrm{1}),(\mathrm{0},\mathrm{1})){}\<[E]%
\\
\>[B]{}\Varid{prj}\;((\Varid{s1},\Varid{facN}),(\Varid{s2},\Varid{fac2N}))\mathrel{=}\Varid{fac2N}\div (\Varid{facN}\mathbin{*}(\Varid{s1}\mathbin{+}\mathrm{1})\mathbin{*}\Varid{facN}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\start
\begin{lcbr}
  \ensuremath{\Varid{facN}\;\mathrm{0}\mathrel{=}\mathrm{1}}
\\
  \ensuremath{\Varid{facN}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{s1}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{*}\Varid{facN}\;\Varid{n}}
\\
  \ensuremath{\Varid{s1}\;\mathrm{0}\mathrel{=}\mathrm{0}}
\\
  \ensuremath{\Varid{s1}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{s1}\;\Varid{n}}
\end{lcbr}
%
\just\equiv{ Igualdade Extensional }
%
\begin{lcbr}
  \ensuremath{\Varid{facN}\comp \Varid{zero}\mathrel{=}\Varid{one}}
\\
  \ensuremath{\Varid{facN}\comp \succ \mathrel{=}\Varid{mul}\comp (\succ \times\Varid{id})\comp \conj{\Varid{s1}}{\Varid{facN}}}
\\
  \ensuremath{\Varid{s1}\comp \Varid{zero}\mathrel{=}\Varid{zero}}
\\
  \ensuremath{\Varid{s1}\comp \succ \mathrel{=}\succ \comp \p1\comp \conj{\Varid{s1}}{\Varid{facN}}}
\end{lcbr}
%
\just\equiv{ Eq-+; Def-in }
%
\begin{lcbr}
  \ensuremath{\Varid{facN}\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}\comp (\succ \times\Varid{id})\comp \conj{\Varid{s1}}{\Varid{facN}}}}
\\
  \ensuremath{\Varid{s1}\comp \mathbf{in}\mathrel{=}\alt{\Varid{zero}}{\succ \comp \p1\comp \conj{\Varid{s1}}{\Varid{facN}}}}
\end{lcbr}
%
\just\equiv{ Absorção-+ }
%
\begin{lcbr}
  \ensuremath{\Varid{facN}\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}\comp (\succ \times\Varid{id})}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s1}}{\Varid{facN}})}
\\
  \ensuremath{\Varid{s1}\comp \mathbf{in}\mathrel{=}\alt{\Varid{zero}}{\succ \comp \p1}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s1}}{\Varid{facN}})}
\end{lcbr}
%
\just\equiv{ Fokkinga }
%
  \ensuremath{\conj{\Varid{s1}}{\Varid{facN}}\mathrel{=}\cata{\conj{\alt{\Varid{zero}}{\succ \comp \p1\comp \conj{\Varid{s1}}{\Varid{facN}}}}{\alt{\Varid{one}}{\Varid{mul}\comp (\succ \times\Varid{id})\comp \conj{\Varid{s1}}{\Varid{facN}}}}}}
%
\just\equiv{ Lei da Troca }
%
  \ensuremath{\conj{\Varid{s1}}{\Varid{facN}}\mathrel{=}\cata{\alt{\conj{\Varid{zero}}{\Varid{one}}}{\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}}}
%
\end{eqnarray*}
Este mesmo processo pode ser usado para obter (2n)!:

(Usaremos uma auxiliar \ensuremath{\Varid{succ2}\mathrel{=}(\mathrm{2}\mathbin{+})})
\begin{eqnarray*}
\start
  \ensuremath{\conj{\Varid{s2}}{\Varid{fac2N}}\mathrel{=}\cata{\alt{\conj{\Varid{zero}}{\Varid{one}}}{\conj{\Varid{succ2}\comp \p1}{\Varid{mul}\comp (\Varid{mul}\comp \conj{\Varid{succ2}}{\succ }\times\Varid{id})}}}}
%
\end{eqnarray*}
Temos então:
\begin{eqnarray*}
...
%
\begin{lcbr}
  \ensuremath{\conj{\conj{\Varid{s1}}{\Varid{facN}}}{\conj{\Varid{s2}}{\Varid{fac2N}}}\mathrel{=}\conj{\cata{\alt{\Varid{a}}{\Varid{b}}}}{\cata{\alt{\Varid{a}}{\Varid{d}}}}}
\\
  \ensuremath{\Varid{a}\mathrel{=}\conj{\Varid{zero}}{\Varid{one}}}
\\
  \ensuremath{\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}
\\
  \ensuremath{\Varid{d}\mathrel{=}\conj{\Varid{succ2}\comp \p1}{\Varid{mul}\comp (\Varid{mul}\comp \conj{\Varid{succ2}}{\succ }\times\Varid{id})}}
\end{lcbr}
%
\just\equiv{ Banana-split }
%
\begin{lcbr}
  \ensuremath{\conj{\conj{\Varid{s1}}{\Varid{facN}}}{\conj{\Varid{s2}}{\Varid{fac2N}}}\mathrel{=}\cata{(\alt{\Varid{a}}{\Varid{b}}\times\alt{\Varid{a}}{\Varid{d}})\comp \conj{\Conid{F}\;\p1}{\Conid{F}\;\p2}}}
\\
  \ensuremath{\Varid{a}\mathrel{=}\conj{\Varid{zero}}{\Varid{one}}}
\\
  \ensuremath{\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}
...
%
\begin{lcbr}
  \ensuremath{\conj{\conj{\Varid{s1}}{\Varid{facN}}}{\conj{\Varid{s2}}{\Varid{fac2N}}}\mathrel{=}\cata{\conj{\alt{\Varid{a}}{\Varid{b}}\comp \Conid{F}\;\p1}{\alt{\Varid{a}}{\Varid{d}}\comp \Conid{F}\;\p2}}}
\\
  \ensuremath{\Varid{a}\mathrel{=}\conj{\Varid{zero}}{\Varid{one}}}
\\
  \ensuremath{\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}
...
%
\begin{lcbr}
  \ensuremath{\conj{\conj{\Varid{s1}}{\Varid{facN}}}{\conj{\Varid{s2}}{\Varid{fac2N}}}\mathrel{=}\cata{\conj{\alt{\Varid{a}}{\Varid{b}}\comp (\Varid{id}\mathbin{+}\p1)}{\alt{\Varid{a}}{\Varid{d}}\comp (\Varid{id}\mathbin{+}\p2)}}}
\\
  \ensuremath{\Varid{a}\mathrel{=}\conj{\Varid{zero}}{\Varid{one}}}
\\
  \ensuremath{\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}
...
%
\begin{lcbr}
  \ensuremath{\conj{\conj{\Varid{s1}}{\Varid{facN}}}{\conj{\Varid{s2}}{\Varid{fac2N}}}\mathrel{=}\cata{\conj{\alt{\Varid{a}}{\Varid{b}\comp \p1}}{\alt{\Varid{a}}{\Varid{d}\comp \p2}}}}
\\
  \ensuremath{\Varid{a}\mathrel{=}\conj{\Varid{zero}}{\Varid{one}}}
\\
  \ensuremath{\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}
...
%
\begin{lcbr}
  \ensuremath{\conj{\conj{\Varid{s1}}{\Varid{facN}}}{\conj{\Varid{s2}}{\Varid{fac2N}}}\mathrel{=}\cata{\alt{\conj{\Varid{a}}{\Varid{a}}}{\conj{\Varid{b}\comp \p1}{\Varid{d}\comp \p2}}}}
\\
  \ensuremath{\Varid{a}\mathrel{=}\conj{\Varid{zero}}{\Varid{one}}}
\\
  \ensuremath{\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}
...
%
\begin{lcbr}
  \ensuremath{\conj{\conj{\Varid{s1}}{\Varid{facN}}}{\conj{\Varid{s2}}{\Varid{fac2N}}}\mathrel{=}\for{\conj{\Varid{b}\comp \p1}{\Varid{d}\comp \p2}}\ {((\mathrm{0},\mathrm{1}),(\mathrm{0},\mathrm{1}))}}
\\
  \ensuremath{\Varid{b}\mathrel{=}\conj{\succ \comp \p1}{\Varid{mul}\comp (\succ \times\Varid{id})}}
\\
  \ensuremath{\Varid{d}\mathrel{=}\conj{\Varid{succ2}\comp \p1}{\Varid{mul}\comp (\Varid{mul}\comp \conj{\Varid{succ2}}{\succ }\times\Varid{id})}}
...
%
\end{eqnarray*}
Daqui, podemos retirar que \ensuremath{\Varid{loop}\mathrel{=}\conj{\Varid{b}\comp \p1}{\Varid{d}\comp \p2}\mathrel{=}\Varid{b}\times\Varid{d}} e \ensuremath{\Varid{inic}\mathrel{=}((\mathrm{0},\mathrm{1}),(\mathrm{0},\mathrm{1}))}.
...
\>[B]{}\Varid{calcLine}\mathbin{::}\Conid{NPoint}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\Varid{calcLine}\;\Varid{l}\;\Varid{l2}\;\Varid{d}\mathrel{=}(\p1\comp (\Varid{cataList}\;(\Varid{g}\;\Varid{d}))\comp \Varid{zip}\;\Varid{l})\;\Varid{l2}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{g}\;\Varid{d}\mathrel{=}\alt{\Varid{b}\;\Varid{d}}{\Varid{q}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{b}\;\Varid{d}\;()\mathrel{=}([\mskip1.5mu \mskip1.5mu],\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{q}\;((\Varid{a},\Varid{b}),(\Varid{l},\Varid{d}))\mathrel{=}(\Varid{linear1d}\;\Varid{a}\;\Varid{b}\;\Varid{d}\mathbin{:}\Varid{l},\Varid{d}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\;\Varid{l}\;\Varid{t}\mathrel{=}(\Varid{hyloAlgForm}\;\Varid{t}\;\Varid{alg}\;\Varid{coalg})\;\Varid{l}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}i_2\;((\Varid{x},\Varid{x}),[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}[\mskip1.5mu \mskip1.5mu])\mathrel{=}i_2\;((\Varid{x},\Varid{y}),[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}\Varid{t})\mathrel{=}i_2\;((\Varid{x},\Varid{y}),\Varid{y}\mathbin{:}\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{alg}\;\Varid{t}\mathrel{=}\alt{\Varid{nil}}{\Varid{algAux}\;\Varid{t}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{algAux}\;\Varid{t}\;((\Varid{x},\Varid{y}),\Varid{r})\mathrel{=}\Varid{calcLine}\;\Varid{x}\;\Varid{y}\;\Varid{t}\mathbin{:}\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloAlgForm}\;\Varid{t}\;\Varid{alg}\;\Varid{coalg}\mathrel{=}(\Varid{auxCasteljau}\;\Varid{t})\comp \Varid{hyloList}\;(\Varid{alg}\;\Varid{t})\;\Varid{coalg}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{auxCasteljau}\;\Varid{a}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{auxCasteljau}\;\Varid{a}\;\Varid{l}\mathrel{=}(\Varid{hyloAlgForm}\;\Varid{a}\;\Varid{alg}\;\Varid{coalg})\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataList}\;\alt{\Varid{b}}{\Varid{q}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{b}\;()\mathrel{=}(\mathrm{0},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{q}\;(\Varid{x},(\Varid{a},\Varid{b}))\mathrel{=}((\Varid{x}\mathbin{+}\Varid{a}\mathbin{*}\Varid{b})\mathbin{/}(\Varid{b}\mathbin{+}\mathrm{1}),\Varid{b}\mathbin{+}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{q}\;\Varid{fs}\mathrel{=}(\Varid{top}\;\Varid{fs}\mathbin{/}\Varid{bottom}\;\Varid{fs},\Varid{bottom}\;\Varid{fs}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{top}\;(\Varid{f1},\Varid{f2})\mathrel{=}\uncurry{(\mathbin{*})}\;\Varid{f1}\mathbin{+}\uncurry{(\mathbin{*})}\;\Varid{f2}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{bottom}\mathrel{=}\uncurry{(\mathbin{+})}\comp (\p2\times\p2){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\tt ~open~Cp\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}1\char41{}~Datatype~Definition~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~type~BTree\char60{}\char39{}a\char62{}~\char61{}~Empty~\char124{}~Node~of~\char39{}a~\char42{}~\char40{}BTree\char60{}\char39{}a\char62{}~\char42{}~BTree\char60{}\char39{}a\char62{}\char41{}\\
\tt ~\\
\tt ~let~inBTree~x~\char61{}~either~\char40{}konst~Empty\char41{}~Node~x\\
\tt ~\\
\tt ~let~outBTree~x~\char61{}~\\
\tt ~~~~~match~x~with\\
\tt ~~~~~\char124{}~Empty~\char45{}\char62{}~i1~\char40{}\char41{}\\
\tt ~~~~~\char124{}~Node~\char40{}a\char44{}\char40{}b1\char44{}b2\char41{}\char41{}~\char45{}\char62{}~i2~\char40{}a\char44{}\char40{}b1\char44{}b2\char41{}\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}2\char41{}~Ana~\char43{}~cata~\char43{}~hylo~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~baseBTree~g~f~x~\char61{}~\char40{}id~\char45{}\char124{}\char45{}~\char40{}g~\char62{}\char60{}~\char40{}f~\char62{}\char60{}~f\char41{}\char41{}\char41{}~x\\
\tt ~\\
\tt ~let~recBTree~f~x~\char61{}~\char40{}baseBTree~id~f\char41{}~x~~~~~~~\char47{}\char47{}~Isto~é\char44{}~id~\char45{}\char124{}\char45{}~\char40{}id~\char62{}\char60{}~\char40{}f~\char62{}\char60{}~f\char41{}\char41{}~\\
\tt ~\\
\tt ~let~rec~cataBTree~a~x~\char61{}~\char40{}a~\char60{}\char60{}~\char40{}recBTree~\char40{}cataBTree~a\char41{}\char41{}~\char60{}\char60{}~outBTree\char41{}~x\\
\tt ~\\
\tt ~let~rec~anaBTree~a~x~\char61{}~\char40{}inBTree~\char60{}\char60{}~\char40{}recBTree~\char40{}anaBTree~a\char41{}\char41{}~\char60{}\char60{}~a\char41{}~x\\
\tt ~\\
\tt ~let~hyloBTree~a~c~x~\char61{}~\char40{}cataBTree~a~\char60{}\char60{}~anaBTree~c\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}3\char41{}~Map~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~\char47{}\char47{}~instance~Functor~BTree\\
\tt ~\char47{}\char47{}~~~~~~where~fmap~f~\char61{}~cataBTree~\char40{}inBTree~\char46{}~baseBTree~f~id\char41{}\\
\tt ~let~fmap~f~x~\char61{}~\char40{}cataBTree~\char40{}inBTree~\char60{}\char60{}~baseBTree~f~id\char41{}\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}4\char41{}~Examples~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}4\char46{}1\char41{}~Inversion~\char40{}mirror\char41{}~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~invBTree~x~\char61{}~cataBTree~\char40{}inBTree~\char60{}\char60{}~\char40{}id~\char45{}\char124{}\char45{}~\char40{}id~\char62{}\char60{}~swap\char41{}\char41{}\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}4\char46{}2\char41{}~Counting~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~countBTree~x~\char61{}~cataBTree~\char40{}either~zero~\char40{}succ~\char60{}\char60{}~uncurry~\char40{}\char43{}\char41{}~\char60{}\char60{}~p2\char41{}\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}4\char46{}3\char41{}~Serialization~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~inord~x~\char61{}\\
\tt ~~~~~let~join~\char40{}x\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~l~\char64{}~\char91{}x\char93{}~\char64{}~r\\
\tt ~~~~~in~either~nil~join~x\\
\tt ~\\
\tt ~let~inordt~x~\char61{}~\char40{}cataBTree~inord\char41{}~x\\
\tt ~\\
\tt ~let~preord~x~\char61{}\\
\tt ~~~~~let~join~\char40{}x\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~\char91{}x\char93{}~\char64{}~l~\char64{}~r\\
\tt ~~~~~in~either~nil~join~x\\
\tt ~\\
\tt ~let~preordt~x~\char61{}~\char40{}cataBTree~preord\char41{}~x\\
\tt ~\\
\tt ~let~postordt~x~\char61{}\\
\tt ~~~~~let~join~\char40{}x\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~l~\char64{}~r~\char64{}~\char91{}x\char93{}\\
\tt ~~~~~in~\char40{}cataBTree~\char40{}either~nil~join\char41{}\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}4\char46{}4\char41{}~Quicksort~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~rec~part~p~x~\char61{}\\
\tt ~~~~~match~x~with\\
\tt ~~~~~\char124{}~\char91{}\char93{}~\char45{}\char62{}~\char40{}\char91{}\char93{}\char44{}\char91{}\char93{}\char41{}\\
\tt ~~~~~\char124{}~\char40{}h\char58{}\char58{}t\char41{}~\char45{}\char62{}\\
\tt ~~~~~~~~~let~\char40{}s\char44{}l\char41{}~\char61{}~part~p~t\\
\tt ~~~~~~~~~in~if~p~h~then~\char40{}h\char58{}\char58{}s\char44{}l\char41{}~else~\char40{}s\char44{}h\char58{}\char58{}l\char41{}\\
\tt ~\\
\tt ~let~qsep~x~\char61{}\\
\tt ~~~~~match~x~with\\
\tt ~~~~~\char124{}~\char91{}\char93{}~\char45{}\char62{}~i1~\char40{}\char41{}\\
\tt ~~~~~\char124{}~\char40{}h\char58{}\char58{}t\char41{}~\char45{}\char62{}\\
\tt ~~~~~~~~~let~y~\char61{}~part~\char40{}\char40{}\char60{}\char41{}~h\char41{}~t\\
\tt ~~~~~~~~~in~i2~\char40{}h\char44{}y\char41{}\\
\tt ~\\
\tt ~let~qSort~x~\char61{}~\char40{}hyloBTree~inord~qsep\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}4\char46{}5\char41{}~Traces~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~cons~a~t~\char61{}~a\char58{}\char58{}t\\
\tt ~\\
\tt ~let~union~x~y~\char61{}~x~\char64{}~y\\
\tt ~\\
\tt ~let~traces~x~\char61{}~\\
\tt ~~~~~let~tunion~\char40{}a\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~\char40{}List\char46{}map~\char40{}cons~a\char41{}~l\char41{}~\char64{}~\char40{}List\char46{}map~\char40{}cons~a\char41{}~r\char41{}~\\
\tt ~~~~~in~cataBTree~\char40{}either~\char40{}konst~\char91{}\char91{}\char93{}\char93{}\char41{}~tunion\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}4\char46{}6\char41{}~Towers~of~Hanoi~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~present~x~\char61{}~inord~x\\
\tt ~\\
\tt ~let~strategy~x~\char61{}\\
\tt ~~~~~match~x~with\\
\tt ~~~~~\char124{}~\char40{}d\char44{}0\char41{}~\char45{}\char62{}~i1~\char40{}\char41{}\\
\tt ~~~~~\char124{}~\char40{}d\char44{}n\char41{}~\char45{}\char62{}~i2~\char40{}\char40{}n\char45{}1\char44{}d\char41{}\char44{}\char40{}\char40{}not~d\char44{}n\char45{}1\char41{}\char44{}\char40{}not~d\char44{}n\char45{}1\char41{}\char41{}\char41{}\\
\tt ~\\
\tt ~let~hanoi~x~\char61{}~\char40{}hyloBTree~present~strategy\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}5\char41{}~Depth~and~balancing~\char40{}using~mutual~recursion\char41{}~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~\\
\tt ~let~balDepth~x~\char61{}\\
\tt ~~~~~let~h~\char40{}a\char44{}\char40{}\char40{}b1\char44{}b2\char41{}\char44{}\char40{}d1\char44{}d2\char41{}\char41{}\char41{}~\char61{}~\char40{}b1~\char38{}\char38{}~b2~\char38{}\char38{}~abs\char40{}d1\char45{}d2\char41{}\char60{}\char61{}1\char44{}1\char43{}max~d1~d2\char41{}\\
\tt ~~~~~in\\
\tt ~~~~~~~~~let~f~\char40{}\char40{}b1\char44{}d1\char41{}\char44{}\char40{}b2\char44{}d2\char41{}\char41{}~\char61{}~\char40{}\char40{}b1\char44{}b2\char41{}\char44{}\char40{}d1\char44{}d2\char41{}\char41{}\\
\tt ~~~~~~~~~in\\
\tt ~~~~~~~~~~~~~let~g~x~\char61{}~\char40{}either~\char40{}konst~\char40{}true\char44{}1\char41{}\char41{}~\char40{}h~\char60{}\char60{}~\char40{}id~\char62{}\char60{}~f\char41{}\char41{}\char41{}~x\\
\tt ~~~~~~~~~~~~~in~cataBTree~g~x\\
\tt ~\\
\tt ~let~balBTree~x~\char61{}~\char40{}p1~\char60{}\char60{}~balDepth\char41{}~x\\
\tt ~\\
\tt ~let~depthBTree~x~\char61{}~\char40{}p2~\char60{}\char60{}~balDepth\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}~Fim~do~module~BTree
\end{tabbing}
