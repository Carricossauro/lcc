...
\begin{figure}[h]
    \centering
    \includegraphics[width = 14cm,height = 10cm]{pagIni.png}
    \caption{Página Principal}
    \label{fig:pagIni}
\end{figure}
...
\begin{figure}[h]%
    ...
    \qquad
    \subfloat[\centering Página de \emph{Sign Up}]{{\includegraphics[width=5cm]{sigUp.png} }}%
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 14cm,height = 10cm]{pagJog.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 14cm,height = 10cm]{menuAut.png}
